...
const int32_t MEDIA_DILUKE = 0x0100000c;
const int32_t MEDIA_FOREGROUND = 0x01000002;
const int32_t MEDIA_GANYU = 0x0100000d;
const int32_t MEDIA_HUTAO = 0x0100000e;
const int32_t MEDIA_KEQING = 0x0100000f;
const int32_t MEDIA_LAYERED_IMAGE = 0x01000003;
const int32_t MEDIA_MONA = 0x01000010;
const int32_t MEDIA_QIN = 0x01000011;
const int32_t MEDIA_QIQI = 0x01000012;
